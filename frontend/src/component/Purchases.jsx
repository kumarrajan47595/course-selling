...
function Purchases() {
    ...
    useEffect(() => {
        const fetchPurchases = async () => {
            try {
                const response = await axios.get("http://localhost:400/api/v1/user/purchases/", {
                    headers: {
    ...
    const handleLogout = async () => {
        try {
            const response = await axios.get("http://localhost:400/api/v1/user/logout", {
                withCredentials: true,
            });
                        ...
                        <li>
                            {isLoggedIn ? (
                                ...
                                <Link to="/signin" className="flex items-center">
                                    <IoLogIn className="mr-2" /> Sign in
                                </Link>
                            )}
                        </li>
                    </ul>
