    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                ...
                setAssessment(response.data.test);
                setLoading(false);
            } catch (error) {
                console.log("error in fetch Assessment ", error);
            }
        };
        fetchCourses();
    }, []);
                    ...
                    {loading ? (
                        ...
                        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                            {assessments?.map((assessment) => (
                                ...
                                >
                                    <h2 className="font-bold text-lg mb-2">{assessment.title}</h2>
                                    ...
                                    {/* Buy page */}
                                    <Link
                                        to={`/buy/${assessment._id}`} // Pass courseId in URL
